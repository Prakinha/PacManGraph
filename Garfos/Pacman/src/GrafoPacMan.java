...
public class GrafoPacMan {
    ...
    public static void main(String args[]) {
        ...
        graph.addNewEdge(23, 24, true);
        graph.addNewEdge(16, 24, true);
        graph.addNewEdge(17, 25, true);
        graph.addNewEdge(25, 26, true);
        graph.addNewEdge(26, 27, true);
        graph.addNewEdge(27, 28, true);
        graph.addNewEdge(28, 29, true);
        graph.addNewEdge(29, 30, true);
        graph.addNewEdge(30, 31, true);
        graph.addNewEdge(31, 32, true);
        graph.addNewEdge(24, 32, true);
        graph.addNewEdge(25, 33, true);
        graph.addNewEdge(33, 34, true);
